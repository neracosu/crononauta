...
EVENTS.forEach(e => {
  out.push(`INSERT INTO eventos (anio,nombre,descripcion,region_id,capa_id,golden,fuente_url) VALUES (` +
    `${n(e.year)},${q(e.name)},${q(e.desc || null)},${n(e.region)},${q(e.layer || 'politica')},${e.golden ? 1 : 0},${q(e.source || null)});`);
});
